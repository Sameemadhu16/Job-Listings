            ...
            <main className="max-w-4xl mx-auto py-12">
                ...
                <div className="bg-white dark:bg-blue-950 shadow-md rounded-md p-6 mt-10">
                    ...
                    <div className="flex space-x-6 mb-6 border-b-2 pb-2">
                        ...
                        <button
                            className={`${activeTab === 'full' ? 'text-blue-700 dark:text-blue-200 font-semibold border-b-2 border-blue-200' : 'text-gray-500 dark:text-gray-300'
                                }`}
                            onClick={getFullTime}
                        >
                            Full Time
                        ...
                        <button
                            className={`${activeTab === 'part' ? 'text-blue-700 dark:text-blue-200 font-semibold border-b-2 border-blue-200' : 'text-gray-500 dark:text-gray-300'
                                }`}
                            onClick={getPartTime}
                        >
                            Part Time
                        ...
                        <button
                            className={`${activeTab === 'users' ? 'text-blue-700 dark:text-blue-200 font-semibold border-b-2 border-blue-200' : 'text-gray-500 dark:text-gray-300'
                                }`}
                            onClick={showUsers}
                        >
                            Users
